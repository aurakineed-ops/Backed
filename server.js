...
const APIS = {
    ...
    'num-india': 'https://ft-osint-api.duckdns.org/api/number?key=YOUR_FTOSINT_KEY&num={query}',
    'num-pak': 'https://ft-osint-api.duckdns.org/api/pk?key=YOUR_FTOSINT_KEY&number={query}',
    'bank': 'https://ft-osint-api.duckdns.org/api/ifsc?key=YOUR_FTOSINT_KEY&ifsc={query}',
    'pan': 'https://ft-osint-api.duckdns.org/api/pan?key=YOUR_FTOSINT_KEY&pan={query}',
    'rc': 'https://leakapi.dpdns.org/rc?registration_number={query}',
    'ip': 'https://ft-osint-api.duckdns.org/api/ip?key=YOUR_FTOSINT_KEY&ip={query}',
    'pincode': 'https://ft-osint-api.duckdns.org/api/pincode?key=YOUR_FTOSINT_KEY&pin={query}',
    'github': 'https://ft-osint-api.duckdns.org/api/git?key=YOUR_FTOSINT_KEY&username={query}',
    'bgmi': 'https://ft-osint-api.duckdns.org/api/bgmi?key=YOUR_FTOSINT_KEY&uid={query}',
    'freefire': 'https://ft-osint-api.duckdns.org/api/ff?key=YOUR_FTOSINT_KEY&uid={query}',
};
